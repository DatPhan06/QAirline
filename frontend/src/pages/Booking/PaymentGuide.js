...
/**
 * PaymentGuide component renders a guide for online booking, canceling booking, and payment methods.
 * It allows users to switch between different guides using buttons.
 *
 * @component
 * @example
 * return (
        ...
        <div className={styles.buttons}>
          <button
            className={`${styles.button} ${
              selectedGuide === "onlineBooking" ? styles.active : ""
            }`}
          ...
          <button
            className={`${styles.button} ${
              selectedGuide === "cancelBooking" ? styles.active : ""
            }`}
          ...
          <button
            className={`${styles.button} ${
              selectedGuide === "paymentMethod" ? styles.active : ""
            }`}
            ...
            <div>
              ...
              <ol>
                <li>
                  ...
                  đi, Điểm đến, Loại vé (một chiều, khứ hồi hay Đa chặng), Ngày
                  khởi hành, Ngày trở về, Số lượng hành Khách: người lớn, trẻ em
                  (nếu có). Sau đó chọn “Tìm chuyến bay” và chọn giờ bay phù
                  hợp.
                </li>
                <li>
                  Lựa chọn hạng vé thích hợp cho chiều đi, và chiều về, bằng
                  cách nhấp chuột vào ô lựa chọn. Chúng tôi sẽ hiển thị bản đồ
                  máy bay theo từng khoang hạng vé Economy, hoặc Business để quý
                  khách lựa chọn.
                ...
                <li>
                  ...
                  chưa nhận được vé điện tử, vui lòng truy cập mục "Quản lý vé"
                  tại website của QAirline, hoặc liên hệ trực tiếp tổng đài qua
                  số điện thoại +84 1900 1900 để nhận được hỗ trợ tốt nhất.
                </li>
              </ol>
            </div>
          )}
