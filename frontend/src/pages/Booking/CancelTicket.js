...
/**
 * CancelTicket component renders the ticket cancellation page.
 * It allows users to select between different ticket classes and view the details of each class.
 *
 * @component
 * @example
 * return (
 ...
 * )
 *
 * @returns {JSX.Element} The CancelTicket component.
 *
 * @description
 * The CancelTicket component maintains the state of the selected ticket class using the useState hook.
 * It displays the details of the selected ticket class in a table format.
 * The component also includes a section for important notes regarding ticket policies.
 *
 * @typedef {Object} TicketDetail
 * @property {string} criteria - The criteria of the ticket detail.
 * @property {string} value - The value or description of the ticket detail.
 *
 * @typedef {Object} TicketDetails
 * @property {TicketDetail[]} saver - The details for the saver class.
 * @property {TicketDetail[]} hotDeal - The details for the hotDeal class.
 *
 * @property {TicketDetails} ticketDetails - An object containing the details for each ticket class.
 *
 * @property {string} selectedClass - The currently selected ticket class.
 * @property {function} setSelectedClass - Function to update the selected ticket class.
 */
const CancelTicket = () => {
          ...
          <div className={styles.ticketSelection}>
            <button
              className={`${styles.ticketButton} ${
                selectedClass === "saver" ? styles.active : ""
              }`}
            ...
            <button
              className={`${styles.ticketButton} ${
                selectedClass === "hotDeal" ? styles.active : ""
              }`}
