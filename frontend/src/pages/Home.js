        ...
        <div className={styles["frame-79"]}>
          <div className={styles["frame-47"]}>
            <div className={styles["frame-19"]}>
              <div className={styles["i-m-n-y-u-th-ch"]}>
                ĐIỂM ĐẾN YÊU THÍCH
              </div>
              <div
                className={
          ...
          <div className={styles["frame-2608773"]}>
            <div className={styles["frame-194"]}>
              <div className={styles["frame-192"]}>
                <div className={styles["frame-74"]}>
                  <img
                    ...
                    src="/images/hanoi.jpeg"
                  />
                </div>
                <div className={styles["frame-196"]}>
                  <div className={styles["istanbul-turkey"]}>
                    Hà Nội, Việt Nam
                  </div>
              ...
              <div className={styles["frame-1962"]}>
                ...
                <div className={styles["frame-196"]}>
                  <div className={styles["baku-azerbaijan"]}>
                    Baku, Azerbaijan
                  </div>
                  <div className={styles["frame-2608766"]}>
                    <div className={styles["flights"]}>Chuyến bay</div>
        ...
        <div className={styles["frame-2608775"]}>
          <div className={styles["frame-2608770"]}>
            <div className={styles["frame-19"]}>
              ...
              <div
                className={styles["what-people-says-about-golobe-facilities"]}
              >
              ...
              <div className={styles["frame-2608764"]}>
                <div className={styles["frame-2608763"]}>
                  <div className={styles["frame-2608756"]}>
                    <div
                      className={styles["a-real-sense-of-community-nurtured"]}
                    >
                    ...
                    <div className={styles["frame-2608757"]}>
                      ...
                      >
                        ...
                        during these tough times. Shoutout to Katie for helping
                        me always, even when I was out of the country. And
                  ...
                  <div className={styles["frame-2608762"]}>
                    <div className={styles["frame-2608758"]}>
                      <img
                        className={styles["ion-star"]}
                        src="ion-star0.svg"
                        alt="Star"
                      />
                      <img
                        className={styles["ion-star2"]}
                        src="ion-star1.svg"
                        alt="Star"
                      />
                      <img
                        className={styles["ion-star3"]}
                        src="ion-star2.svg"
                        alt="Star"
                      />
                      <img
                        className={styles["ion-star4"]}
                        src="ion-star3.svg"
                        alt="Star"
                      />
                      <img
                        className={styles["ion-star5"]}
                        src="ion-star4.svg"
                        alt="Star"
                      />
                    </div>
                    <div className={styles["frame-2608759"]}>
                      <div className={styles["frame-2608761"]}>
                        ...
                        <div className={styles["weave-studios-kai-tak"]}>
                          Weave Studios – Kai Tak
                        </div>
                      </div>
                      <div className={styles["frame-2608760"]}>
                        <img
                          className={styles["flat-color-icons-google"]}
                          src="flat-color-icons-google0.svg"
                          alt="Google"
                        />
                ...
                <img
                  className={styles["rectangle-36"]}
                  src="rectangle-360.png"
                  alt="Reviewer"
                />
              </div>
            </div>
              ...
              <div className={styles["frame-2608784"]}>
                <div className={styles["frame-2608786"]}>
                  ...
                  <div
                    className={
                      styles[
                        "search-flights-places-hire-to-our-most-popular-destinations2"
                      ]
                    }
                  >
